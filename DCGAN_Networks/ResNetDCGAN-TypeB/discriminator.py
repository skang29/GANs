...
def discriminator(image_, batch_size, df_dim, name="discriminator", sn=True, reuse=False, debug=False):
...
def init_stage(image_, batch_size, conv_dims, name="init_stage", sn=False):
    with tf.variable_scope(name):
        ...
        nets = residual_block(nets, conv_dims, normalization=False, sn=sn)
